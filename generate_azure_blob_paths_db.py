...
def assertion_callback():
    ...
    res = sts.get_web_identity_token(Audience=["api://AzureADTokenExchange"], DurationSeconds=300,
                                     SigningAlgorithm="RS256")
    return res["WebIdentityToken"]


def download_file_paths_and_names(pages):
